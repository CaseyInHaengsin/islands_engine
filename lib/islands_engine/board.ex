defmodule IslandsEngine.Board do
  ...
  def new(), do: %{}
  # Positioning Islands
  # Delegate function calls down to them individually or as a group

  # Actions - positioning islands, ensuring that all islands are positioned, and guessing coordinates
